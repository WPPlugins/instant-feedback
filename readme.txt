...
Tags:facebook,reaction,like,emotion,facebook reaction
Requires at least: 3.5
Tested up to: 4.7.2

Facebook style emoji reaction plugin, which is more customizable than any other plugin

== Description ==

Myeffecto emotion reaction plugin is the most easily customizable plugin, available on wordpress.
All our service, analytics, etc are free for wordpress community


= Features =

* **Instant Visual Feedback :**
Track your visitor sentiments by one-click feedback

* **Share With Emotion :**
Share your blog post with emotion hashtags and emoji

* **Recommendation :**
Recommend post within your blogs based on visitor's reaction

* **Customization :**
Customize emoticon names, look and feel

* **Upload :**
icons/emoji's of your choice

[youtube https://www.youtube.com/watch?v=GlwJOPpe6bs]
...
= Other Features =
* **Custom-Widget :**
	Based on user request we have provided custom widgets like Most-Voted content, trending article sidebar. We use wordpress short-code for custom-widget, For more info visit : [myeffecto.com/wordpress](http://www.myeffecto.com/wordpress?type=shortcode)

* **Blog Promotion :**
   We provide *Free* Blog promotion for some selected blog's based on category, content and type of blog. To bring more traffic to your website


= Support =

Email [support(at)myeffecto(dot)com](http://www.myeffecto.com/contact) for any help.  
...
please write to us at [support(at)myeffecto(dot)com](http://www.myeffecto.com/contact)
...
For any unanswered questions, please write to us at [support(at)myeffecto(dot)com](http://www.myeffecto.com/contact)	

== Screenshots ==

1. Myeffecto plugin CSS version
2. Myeffecto plugin Image version
3. Myeffecto plugin after click (share & recommendation)
4. Myeffecto admin page in wordpress
5. Myeffecto plugin create page
6. Myeffecto plugin-setting page
...
= 2.9 =
Security & Privacy issue fixed
Some ohter Bug Fix. 
Plugin updated for Wordpress 4.5.2
