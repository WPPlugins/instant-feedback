...
$mye_script = "//cdneffecto.blob.core.windows.net/jsc/mye-wp.js";
$mye_script_all = "//cdneffecto.blob.core.windows.net/jsc/mye-wp-a.js";


$eff_ssl_host = "https://myeffecto.azurewebsites.net";
...
{	
	...
	if(is_ssl() || isset($eff_secure) && $eff_secure==="1"){
		...
		$mye_script = "https:".$mye_script ;
		$mye_script_all = "https:".$mye_script_all ;
	}	
	else{
		$hostString ="http:".$hostString;
		$mye_script = "http:".$mye_script ;
		$mye_script_all = "http:".$mye_script_all ;
